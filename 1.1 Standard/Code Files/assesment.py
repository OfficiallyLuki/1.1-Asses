...
if a == "a": # If the user gets the answer on the first try they following will run;
        ...
        msgbox(str(player_name) + " , you got your question right the first time") # Provides the user with the information that they got the question right on the first time
else :  # Repeats the question until they get it right or it repeats twice
        (total) # Sets total to be the same
        msgbox(str(player_name) + ", you got your question wrong!")  # If the user gets it wrong they'll be presented with this
        a = buttonbox(str(player_name) + " , Somone sends you a text that is hurtful and makes you feel bad about yourself. What should you do?", choices=["Delete the message and try to forget about it","Keep the text and show an adult you trust","Text the person back saying something mean to them"]) # Repeated Question
        if a == "a": # If they get it right within two goes they'll be presented with this
            ...
            msgbox(str(player_name) + ", you got your question right in this amount of trys\n\n" + str(2))

# Second Question of the quiz

c = buttonbox(str(player_name) + " , Someone in your class has posted their first video on YouTube and has asked you to comment on it. You don't think the video is good because the editing is very choppy. What could you comment? \n\n A. Your video is rubbish!\n B. Man, this is awful! Stick to playing sport or something.\n C. Congrats on your first video! Let me know if you'd like any help editing for your next video.", choices='a' 'b' 'c') # Provides the user with the question and three choices
...
b = buttonbox(str(player_name) + " , Someone sends you a text that is hurtful and makes you feel bad about yourself. What should you do? \n\n A. Delete the message and try forget about it\n B. Keep the text and show an adult you trust\n C. Text the person back saying something mean to them", choices='a' 'b' 'c') # Provides the user with the question and three choices
...
msgbox(str(player_name) + " well done! You've finished the quiz, you got " + str(total) + "/3 correct! If you want to you can retry this quiz, or move onto the next quiz for 14+ Cybersmart Youth Quiz, you can!.")